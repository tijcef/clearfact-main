...
export const Route = createFileRoute("/advertise")({
  head: () => ({
    meta: [
      { title: "Advertise — ClearFact News" },
      {
        name: "description",
        content:
          "Reach a verified, engaged Nigerian audience through ClearFact News advertising and sponsorship programmes.",
      },
  ...
  component: () => (
    <SimplePage
      eyebrow="Advertise"
      title="Reach Nigeria's most discerning readers."
    ...
    >
      ...
      <p>
        Email <a href="mailto:clearfactmedia@gmail.com">clearfactmedia@gmail.com</a> for the latest
        media kit.
      </p>
    </SimplePage>
  ),
