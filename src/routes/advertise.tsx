...
component: () => ( <SimplePage
 ...
 > <section> <p> <strong>ClearFact News</strong> is a digital-first Nigerian news
platform focused on verified journalism, public-interest reporting
and stories that matter to our readers. </p>
...
```
  ...
  <section>
    ...
    <ul>
      <li>
        <strong>Trusted Editorial Environment</strong> — Your brand appears
        alongside professionally produced journalism and clearly
      ...
      <li>
        <strong>Editorial Transparency</strong> — Advertising and sponsored
        content are clearly identified and remain separate from
  ...
  <section>
    ...
    <p>
      <strong>Email:</strong>{" "}
      <a href="mailto:clearfactmedia@gmail.com">
