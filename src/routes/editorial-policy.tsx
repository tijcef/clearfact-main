...
export const Route = createFileRoute("/editorial-policy")({
  ...
  component: () => (
    ...
    >
      <section>
        <p>
          <strong>ClearFact News</strong> is committed to accurate, independent,
          fair and responsible journalism. Our editorial decisions are guided
          by the public interest and our responsibility to provide readers with
          reliable information.
        </p>

        <p>
          We clearly distinguish between verified facts, allegations, opinions,
      ...
      <section>
        ...
        <p>
          We do not knowingly publish manipulated or misleading visual material
          as authentic.
        </p>
      ...
      <section>
        ...
        <p>
          Sensitive personal information should not be published merely because
          it is available. Editors should consider relevance, verification,
          potential harm and legitimate public interest.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ClearFact News may review and update this Editorial Policy as our
          newsroom, technology, journalism practices and responsibilities
          evolve.
        </p>

        <p>
          Any material changes to our editorial standards will be reflected on
          this page so that readers can understand the principles guiding our
          journalism.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="font-serif text-2xl leading-9">
          <strong>
            Verified Journalism. Public Trust. Meaningful Impact.
          </strong>
        </p>
