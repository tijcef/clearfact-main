...
export const Route = createFileRoute("/careers")({
  head: () => ({
    meta: [
      { title: "Careers — ClearFact News" },
      {
        name: "description",
        content:
          "Join an independent Nigerian newsroom. Open roles in reporting, fact-checking, engineering and design.",
      },
  ...
  component: () => (
    <SimplePage
      eyebrow="Careers"
      title="Build the future of African journalism."
    ...
    >
      ...
      <p>
        Send your CV and clips to{" "}
        <a href="mailto:clearfactmedia@gmail.com">clearfactmedia@gmail.com</a>.
      </p>
    </SimplePage>
  ),
});
