...
```
    ...
    <p className="text-muted-foreground mt-4 text-lg leading-7">
      Send ClearFact News a news tip, document, investigation lead or
      information that may be in the public interest.
    </p>
  </div>
  ...
  <div className="mt-10 grid lg:grid-cols-3 gap-8">
    ...
    <section className="lg:col-span-1 space-y-6">
      ...
      <div className="rounded-sm border border-border bg-card p-6">
        ...
        <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
          <li>
            • Tell us what happened and why you believe it matters.
          </li>

          <li>
            • Provide dates, locations, names and other useful context.
          </li>

          <li>
            • Include supporting documents or links where available.
          </li>

          <li>
            • Do not knowingly submit false or fabricated information.
          </li>
      ...
      <div className="rounded-sm border border-border bg-card p-6">
        ...
        <p className="text-sm text-muted-foreground mt-2 leading-6">
          If you prefer to contact the newsroom directly, reach our
          editorial desk.
        </p>
      ...
      >
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Give our newsroom enough information to understand and assess
            your submission.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-2">
            You may leave this blank if you do not want to provide contact
            information.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1 leading-5">
                This form is currently a general submission channel and
                should not be treated as an anonymous or technically secure
                whistleblower system. Do not submit highly sensitive
                information until ClearFact's secure submission
        ...
        <p className="text-xs text-muted-foreground leading-5">
          Submissions are reviewed for editorial relevance and
          verification. Submission does not guarantee publication.
        </p>
      </form>
    </section>
  </div>
  ...
  <section className="mt-14 border-t border-border pt-10 max-w-4xl">
    ...
    <div className="grid md:grid-cols-3 gap-6 mt-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-2 leading-6">
          Our team reviews the information to determine whether it has
          legitimate editorial or public-interest value.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-2 leading-6">
          Relevant claims may be checked against documents, official
          records, interviews and independent sources.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-2 leading-6">
          If the information supports a legitimate story, our newsroom may
          conduct further reporting before publication.
        </p>
      </div>
    </div>
  </section>
  ...
  <section className="mt-12 rounded-sm border border-border bg-card p-6 md:p-8">
    <h2 className="font-serif text-2xl">
      Have a story worth investigating?
    </h2>

    <p className="text-sm text-muted-foreground mt-2 leading-6">
      ClearFact News is committed to journalism that informs the public,
      strengthens accountability and gives communities a voice.
    </p>
